...
* [LDAP Object Classes](http://www.ldapexplorer.com/en/manual/107060000-ldap-object-classes.htm) [ad object classes definition, objectClasses]
...
* core
   ...
   * [Java Tutorial](http://tutorials.jenkov.com/java/index.html) - \[2015.02, @jjenkov, java enums, java annotations, java inheritance, java beginner, java lambda expressions \]
...
* [How do I test whether an element exists?](https://learn.jquery.com/using-jquery-core/faq/how-do-i-test-whether-an-element-exists/) - [jquery test element exists]
 ...
 * [“NODE_ENV” is not recognized as an internal or external command, operable command or batch file](http://stackoverflow.com/questions/11928013/node-env-is-not-recognized-as-an-internal-or-external-command-operable-comman) - [node env variables, node stackoverflow]
...
* [Tweet button](https://dev.twitter.com/web/tweet-button) - [twitter sharing, twitter sharing button, twitter share, twitter add button website, twitter official]
 * [Tweet button parameter reference ](https://dev.twitter.com/web/tweet-button/parameters) - [twitter sharing, twitter sharing button, twitter share, twitter add button website, twitter official, twitter data-*]
